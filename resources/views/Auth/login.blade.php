...
<html
  ...
  <head>
    ...
    <title>Pemantapan | Gavin - RPL</title>
        ...
        <div class="authentication-inner py-6 mx-4">
          ...
          <div class="card p-sm-7 p-2">
            ...
            <div class="card-body mt-1">
              ...
              <form id="formAuthentication" class="mb-5" action="{{ route('dashboard') }}" method="GET">
                ...
                <div class="mb-5">
                  <button class="btn btn-primary d-grid w-100" href="{{ route('dashboard') }}" type="submit">login</button>
                </div>
              </form>
